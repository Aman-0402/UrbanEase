...
export const proposeNegotiation  = (id, data)   => api.patch(`/bookings/${id}/negotiate/`, data)
export const respondNegotiation  = (id, data)   => api.patch(`/bookings/${id}/negotiate-response/`, data)
