...
const s = {
  ...
  left: {
    width: "42%",
    background: "linear-gradient(145deg,#7c3aed 0%,#6d28d9 55%,#4338ca 100%)",
    padding: "60px 56px",
    display: "flex",
  ...
  pwRule: (ok) => ({
    ...
    gap: "4px",
    fontSize: "12px",
    color: ok ? "#7c3aed" : "#9ca3af",
  }),
  bar: (ok) => ({
    height: "3px",
    flex: 1,
    borderRadius: "4px",
    background: ok ? "#7c3aed" : "#e5e7eb",
      ...
      <div style={s.left} className="reg-left">
        ...
        >
          <h2 style={s.h2}>
            Join thousands of
            <br />
            <span style={s.accent}>happy customers</span>
          </h2>
          <p style={s.sub}>
            Create a free account and book your first home service in under 2
            minutes.
          </p>
          {[
      ...
      <div style={s.right}>
        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <div style={s.formGrid}>
              <div>
                ...
                <input
                  ...
                  onBlur={(e) =>
                    Object.assign(e.target.style, blurStyle(errors.full_name))
                  }
                />
                {errors.full_name && (
                  <p style={s.errMsg}>
              ...
              <div>
                ...
                <input
                  ...
                  onFocus={(e) => Object.assign(e.target.style, focusStyle)}
                  onBlur={(e) =>
                    Object.assign(e.target.style, blurStyle(errors.phone))
                  }
                />
                {errors.phone && (
                  <p style={s.errMsg}>
            ...
            <div style={s.field}>
              <label style={s.label}>
                Email <span style={s.labelOpt}>(optional)</span>
              </label>
              <input
                type="email"
                ...
                onFocus={(e) => Object.assign(e.target.style, focusStyle)}
                onBlur={(e) =>
                  Object.assign(e.target.style, blurStyle(errors.email))
                }
              />
              {errors.email && (
                <p style={s.errMsg}>
            ...
            <div style={s.field}>
              ...
              <div style={{ position: "relative" }}>
                <input
                  ...
                  onFocus={(e) => Object.assign(e.target.style, focusStyle)}
                  onBlur={(e) =>
                    Object.assign(e.target.style, blurStyle(errors.password))
                  }
                />
                <button
                  type="button"
                ...
                <>
                  ...
                  >
                    {passwordRules.map((_, i) => (
                      <div key={i} style={s.bar(i < pwStrength)} />
                    ))}
                  </div>
                  <div style={s.pwRules}>
              ...
              <div style={{ position: "relative" }}>
                <input
                  ...
                  onBlur={(e) =>
                    Object.assign(
                      e.target.style,
                      blurStyle(errors.confirm_password),
                    )
                  }
                />
                <button
